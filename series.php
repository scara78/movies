...
foreach ($data as $film) :
	...
	$link_film = "https://database.gdriveplayer.us/player.php?type=drama&id=271433&episode=" . $eps;
									...
									<div class="element-click"><button class="button button-shadow">Semua Episode<span class="arrow_carrot-down"></span></button>
										<div class="listwrap dropdown">
											<ul class="gmr-listseries">
												...
												for ($i = 1; $i <= $episode; $i++) : ?>
													<li><a href="/eps/<?= $i . '/' . $url . '-episode-' . $i . '-subtitle-indonesia-' . dechex($id_film) ?>" title="$title"><?= $title ?> Episode <?= $i ?> Subtitle Indonesia</a></li>
												<?php endfor; ?>
							...
							<div class="gmr-box-content gmr-single">
								...
								<div class="entry-content entry-content-single" itemprop="description">
									...
									<div class="clearfix content-moviedata">
										<p><?= $desc ?></p>
										<div class="gmr-moviedata"><strong>Sutradara:</strong>
											<?php foreach ($created_by as $created_by_key) : ?><?= $created_by_key['name'] ?>, <?php endforeach; ?>
										</div>
								...
								<div class="gmr-grid idmuvi-core">
									<h3 class="widget-title gmr-related-title">Select Movies</h3>
									<div class="row grid-container">
										<?php search_player($title) ?>
