			...
			<div class="row">
				<div class="col-md-12">
					<div class="breadcrumbs" itemscope="itemscope" itemtype="http://schema.org/BreadcrumbList">
						...
						<span itemprop="itemListElement" itemscope="itemscope" itemtype="http://schema.org/ListItem">
							<a itemprop="item" href="<?= site_url() . '/' . strtolower($genre_name[0]["name"]) ?>">
			...
			<div class="row" style="transform: none;">
				<div id="primary" class="content-area col-md-9">
					<main id="main" class="site-main" role="main">
						<article id="post" class="single-thumb post post type-post status-publish format-standard has-post-thumbnail hentry" itemscope="itemscope" itemtype="http://schema.org/Movie">
							<div class="gmr-box-content gmr-single">
								...
								<div class="entry-content entry-content-single" itemprop="description">
									...
									<div class="clearfix content-moviedata">
										...
										<div class="gmr-moviedata"><strong>Tagline:</strong><?= $tagline ?></div>
										<div class="gmr-moviedata"><strong>Release:</strong><span><time itemprop="dateCreated" datetime="<?= $release ?>T00:00:00+00:00"><?= $release ?></time></span></div>
										<div class="gmr-moviedata"><strong>Budget:</strong>$ <?= $budget ?></div>
										<div class="gmr-moviedata"><strong>Revenue:</strong>$ <?= $revenue ?></div>
									</div>
									<p><a href="<?= site_url() ?>"><strong>LAYARKACA21</strong></a> kami menyediakan film
										bioskop online Lk21 terbaru jaminan kualitas movie yang terang dengan kata lain
										sudah bisa di nonton Cinemaindo oleh anda dan juga keluarga terdekat dari gadget
										hape maupun smartphone Layarkaca21 kesayangan anda. Mohon beri kami dukungan dengan
										ajak teman-teman / kerabat terdekat anda untuk menonton Layar Kaca 21 film bioskop
										21 disini saja ya bos. Jika ada keluhan <b>Ganool</b>&nbsp;anda yang ingin membantu
										memberikan kritik serta saran mohon beritahu kami di Ganool alamat kontak yang sudah
										kami sediakan di bagian laman&nbsp;<b>Lk21</b>&nbsp;menu website lk 21 ini ya guy.
									</p>
									<h2>Download Film Layar kaca 21 Nonton Movie Indoxxi Lk21</h2>
									<p><strong>layar Kaca 21 Nonton Movie Ganool Streaming Film Cinemaindo video Online Lk21
											LayarKaca21 Cinema XXI Indoxxi Dunia21 Gudangmovie.</strong> Disini Lk21
										menyediakan film film layar Kaca 21 online Lk21 terbaru dengan kualitas mutu movie
										yang terang dengan kata lain sudah dapat di nonton Cinemaindo oleh anda dan
										<strong>Dunia21</strong>&nbsp;kembali keluarga terdekat Ganool awal gadget
										Gudangmovie hape maupun ponsel pintar Layarkaca21 kesayangan kamu</p>
									<h2>CinemaIndo Movie Layar Kaca 21 Kualitas Film Paling Bagus Lengkap Dengan Subtitle
										Indonesia</h2>
									<p>Streaming Lk21 Film film 21 Online teranyar Nonton Film Dunia21 web Cinemaindo
										...
										unduh Movie 21 dengan cara cuma-cuma hanya Ada Di Sini! Nonton Movie Online Subtitle
										Indonesia Film HD Lk21 Koleksi Ganool Movie Online terbaru download Layarkaca21 Film
										Indoxxi dengan cara free <strong>Gudangmovie</strong> Disini Boskuuu.</p>
									<div class="clearfix content-moviedata">
										<div class="gmr-moviedata"><strong>Country:</strong>
											<span itemprop="contentLocation" itemscope="itemscope" itemtype="http://schema.org/Place">
												<?php foreach ($country as $country_key) : ?>
													<a href="<?= site_url() ?>/country/<?= strtolower($country_key[" name"]) ?>" rel="tag"><?= $country_key["name"] ?></a>,
												<?php endforeach; ?>
