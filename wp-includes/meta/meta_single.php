...
<head itemscope="itemscope" itemtype="http://schema.org/WebSite">
    ...
    <title>Nonton Film <?= $title; ?> | <?= $profile->website_name; ?></title>
    <meta name="description" content="Nonton <?= $title; ?> <?= $profile->description; ?>">
    <link rel="canonical" href="<?= site_url() ?>/">
    <meta property="og:type" content="article">
    <meta property="og:title" content="Nonton Film <?= $title; ?> | <?= $profile->website_name; ?>">
    <meta property="og:description" content="Nonton Film <?= $title; ?> <?= $profile->website_name; ?> - <?= $profile->description; ?>">
    <meta property="og:url" content="<?= site_url() ?>/">
    <meta property="og:site_name" content="Nonton Film <?= $title; ?> | <?= $profile->website_name; ?>">
    <meta name="twitter:card" content="summary">
    <meta name="twitter:description" content="Nonton Film <?= $title; ?> <?= $profile->description; ?>">
    <meta name="twitter:title" content="Nonton Film <?= $title; ?> | <?= $profile->description; ?>">
