...
<head itemscope="itemscope" itemtype="http://schema.org/WebSite">
    ...
    <title><?= $profile->website_name; ?> - <?= $profile->description; ?></title>
    <meta name="description" content="<?= $profile->website_name; ?>">
    <link rel="canonical" href="<?= site_url() ?>/">
    <meta property="og:type" content="website">
    <meta property="og:title" content="<?= $profile->website_name; ?> - <?= $profile->description; ?>">
    <meta property="og:description" content="<?= $profile->website_name; ?>">
    <meta property="og:url" content="<?= site_url() ?>/">
    <meta property="og:site_name" content="<?= $profile->website_name; ?> - <?= $profile->description; ?>">
    <meta name="twitter:card" content="summary">
    <meta name="twitter:description" content="<?= $profile->website_name; ?>">
    <meta name="twitter:title" content="<?= $profile->website_name; ?> - <?= $profile->description; ?>">
    <link rel="dns-prefetch" href="//s0.wp.com">
    <link rel="dns-prefetch" href="//fonts.googleapis.com">
    <link rel="dns-prefetch" href="//s.w.org">
    <link rel="alternate" type="application/rss+xml" title="<?= $profile->website_name; ?> - <?= $profile->description; ?> » Feed" href="<?= site_url() ?>/feed/">
    <link rel="alternate" type="application/rss+xml" title="<?= $profile->website_name; ?> - <?= $profile->description; ?> » Comments Feed" href="<?= site_url() ?>/comments/feed/">
